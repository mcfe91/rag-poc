...
class WhatCanIDoTool(Tool):
    ...
    inputs = {
        "question": {
            "type": "string",
            "description": "question: The user's query about system capabilities. While this parameter is required, the function returns a standard capability list regardless of the specific question.",
        }
    }
    output_type = "string"

    @track(name="WhatCanIDo.forward")
