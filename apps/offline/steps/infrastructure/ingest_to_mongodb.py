...
from offline.infrastructure.mongo.service import MongoDBService
...
def ingest_to_mongodb(
    ...
    logger.info(f"Ingesting {len(models)} documents of type '{model_type.__name__}' into MongoDB collection '{collection_name}'")
