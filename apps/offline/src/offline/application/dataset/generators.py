...
from offline.domain import Document, InstructDataset, InstructDatasetSample

class SummarizationDatasetGenerator:
    """Generates an instruction dataset from documents by creating summaries.

    This class takes a list of documents and generates summarries using a specified
    ...
    def generate(self, documents: list[Document]) -> InstructDataset:
        ...
        Returns:
            ...
            document contents and aswers are generated summaries.
        ...
        instruct_dataset_samples = [
            ...
            for summarized_document in filtered_summarized_documents if summarized_document
        ]
    ...
    def __summarize_documents(self, documents: list[Document]) -> list[Document]:
        ...
        filtered_documents = self.__filter_documents(
        ...
        filtered_summarized_documents = self.__filter_documents(
